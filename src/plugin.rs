...
impl Plugin for BevyLdtkAssetPlugin {
    fn build(&self, app: &mut App) {
        ...
        #[cfg(feature = "asset_messages_debug")]
        {
            ...
            use crate::systems::asset_messages_debug::asset_messages_debug_output;

            app.add_systems(
                Update,
                (
                    asset_messages_debug_output::<Project>,
                    asset_messages_debug_output::<World>,
                    asset_messages_debug_output::<Level>,
                    asset_messages_debug_output::<LayerInstance>,
                    asset_messages_debug_output::<EntityInstance>,
                ),
            );
        }
    }
